...
export const metadata: Metadata = {
  title: "Pest Control Mission KS | All Star Pest Solutions",
  description:
    "Pest control in Mission KS for ants, termites, spiders, rodents, cockroaches, mosquitoes, bed bugs, fleas, wasps, and more. No mandatory contracts.",
};
    ...
    <main className="bg-white text-slate-950">
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight md:text-6xl">
          Pest Control Mission KS
        </h1>

        <p className="mt-6 text-xl font-semibold leading-8 text-slate-700">
          All Star Pest Solutions provides owner-operated pest control in Mission KS
        ...
        <div className="mt-10 grid gap-6">
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Pest Problems We See Around Mission KS</h2>
            <p className="mt-4 text-lg leading-8 text-slate-700">
              Homes in Mission KS can deal with dense neighborhoods, older structures, roaches, ants, spiders, and rodent entry points. The right treatment depends on
          ...
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Services Available in Mission KS</h2>
          ...
          <article className="rounded-3xl border border-slate-200 bg-slate-950 p-8 text-white">
            <h2 className="text-3xl font-black">Why Mission KS Homeowners Call All Star</h2>
