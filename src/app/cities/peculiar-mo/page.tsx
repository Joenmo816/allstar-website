...
export const metadata: Metadata = {
  ...
  description:
    "Pest control in Peculiar MO for ants, termites, spiders, rodents, cockroaches, mosquitoes, bed bugs, fleas, wasps, and more. No mandatory contracts.",
};
    ...
    <main className="bg-white text-slate-950">
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight md:text-6xl">
          Pest Control Peculiar MO
        </h1>

        <p className="mt-6 text-xl font-semibold leading-8 text-slate-700">
          All Star Pest Solutions provides owner-operated pest control in Peculiar MO
        ...
        <div className="mt-10 grid gap-6">
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Pest Problems We See Around Peculiar MO</h2>
            <p className="mt-4 text-lg leading-8 text-slate-700">
              Homes in Peculiar MO can deal with country-edge homes, rodents, termites, ants, spiders, mosquitoes, fleas, and wasps. The right treatment depends on
          ...
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Services Available in Peculiar MO</h2>
