...
export const metadata: Metadata = {
  ...
  description:
    "Local pest control in Stilwell KS from All Star Pest Solutions. Ants, termites, spiders, rodents, mosquitoes, cockroaches, bed bugs, and more. No mandatory contracts.",
};

export default function Page() {
  return (
    <SeoLandingPage
      title="Pest Control Stilwell KS | Local, Experienced, No Contracts"
      eyebrow="Stilwell KS Pest Control"
      description="All Star Pest Solutions provides safe, targeted pest control for homeowners and businesses in Stilwell KS and the surrounding Kansas City metro."
      sections={[
        {
          heading: "Local Pest Control for Stilwell KS",
          body: [
