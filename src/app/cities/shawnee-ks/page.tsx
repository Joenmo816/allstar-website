...
export const metadata: Metadata = {
  title: "Pest Control Shawnee KS | All Star Pest Solutions",
  description:
    "Pest control in Shawnee KS for ants, termites, spiders, rodents, cockroaches, mosquitoes, bed bugs, fleas, wasps, and more. No mandatory contracts.",
};
    ...
    <main className="bg-white text-slate-950">
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight md:text-6xl">
          Pest Control Shawnee KS
        </h1>

        <p className="mt-6 text-xl font-semibold leading-8 text-slate-700">
          All Star Pest Solutions provides owner-operated pest control in Shawnee KS
        ...
        <div className="mt-10 grid gap-6">
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Pest Problems We See Around Shawnee KS</h2>
            <p className="mt-4 text-lg leading-8 text-slate-700">
              Homes in Shawnee KS can deal with suburban homes, wooded areas, ants, spiders, mosquitoes, termites, and rodents. The right treatment depends on
          ...
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Services Available in Shawnee KS</h2>
          ...
          <article className="rounded-3xl border border-slate-200 bg-slate-950 p-8 text-white">
            <h2 className="text-3xl font-black">Why Shawnee KS Homeowners Call All Star</h2>
