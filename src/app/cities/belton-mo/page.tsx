...
export const metadata: Metadata = {
  ...
  description:
    "Local pest control in Belton MO from All Star Pest Solutions. Ants, termites, spiders, rodents, mosquitoes, cockroaches, bed bugs, and more. No mandatory contracts.",
};

export default function Page() {
  return (
    <SeoLandingPage
      title="Pest Control Belton MO | Local, Experienced, No Contracts"
      eyebrow="Belton MO Pest Control"
      description="All Star Pest Solutions provides safe, targeted pest control for homeowners and businesses in Belton MO and the surrounding Kansas City metro."
      sections={[
        {
          heading: "Local Pest Control for Belton MO",
          body: [
