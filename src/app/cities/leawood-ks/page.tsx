...
export const metadata: Metadata = {
  title: "Pest Control Leawood KS | All Star Pest Solutions",
  description: "Pest control in Leawood KS for ants, termites, spiders, rodents, cockroaches, mosquitoes, bed bugs, wasps, fleas, and more.",
};
    ...
    <main className="bg-white text-slate-950">
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight md:text-6xl">
          Pest Control Leawood KS | Local, Experienced, No Contracts
        </h1>

        <p className="mt-6 text-xl font-semibold leading-8 text-slate-700">
          All Star Pest Solutions serves Leawood KS with targeted pest control, termite inspections, ant treatments, spider control, rodent service, cockroach control, mosquito service, flea service, bed bug service, and wasp control.
        </p>

        <div className="mt-10 grid gap-6">
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Pest Problems in Leawood KS</h2>
            <p className="mt-4 text-lg leading-8 text-slate-700">
              Homes around Leawood KS can deal with ants, spiders, termites, rodents, mosquitoes, cockroaches, wasps, fleas, and occasional invaders. The right treatment depends on the pest, the structure, the season, and the conditions around the property.
            </p>
          </article>
          ...
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Why Leawood KS Homeowners Call All Star</h2>
            <p className="mt-4 text-lg leading-8 text-slate-700">
