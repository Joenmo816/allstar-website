...
export const metadata: Metadata = {
  title: "Pest Control Prairie Village KS | All Star Pest Solutions",
  description:
    "Pest control in Prairie Village KS for ants, termites, spiders, rodents, cockroaches, mosquitoes, bed bugs, fleas, wasps, and more. No mandatory contracts.",
};
    ...
    <main className="bg-white text-slate-950">
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight md:text-6xl">
          Pest Control Prairie Village KS
        </h1>

        <p className="mt-6 text-xl font-semibold leading-8 text-slate-700">
          All Star Pest Solutions provides owner-operated pest control in Prairie Village KS
        ...
        <div className="mt-10 grid gap-6">
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Pest Problems We See Around Prairie Village KS</h2>
            <p className="mt-4 text-lg leading-8 text-slate-700">
              Homes in Prairie Village KS can deal with older homes, crawlspaces, basements, ants, spiders, rodents, and moisture-related pest issues. The right treatment depends on
          ...
          <article className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            <h2 className="text-3xl font-black">Services Available in Prairie Village KS</h2>
          ...
          <article className="rounded-3xl border border-slate-200 bg-slate-950 p-8 text-white">
            <h2 className="text-3xl font-black">Why Prairie Village KS Homeowners Call All Star</h2>
