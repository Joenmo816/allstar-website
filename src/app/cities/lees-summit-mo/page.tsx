...
export const metadata: Metadata = {
  ...
  description:
    "Local pest control in Lee's Summit MO from All Star Pest Solutions. Ants, termites, spiders, rodents, mosquitoes, cockroaches, bed bugs, and more. No mandatory contracts.",
};

export default function Page() {
  return (
    <SeoLandingPage
      title="Pest Control Lee's Summit MO | Local, Experienced, No Contracts"
      eyebrow="Lee's Summit MO Pest Control"
      description="All Star Pest Solutions provides safe, targeted pest control for homeowners and businesses in Lee's Summit MO and the surrounding Kansas City metro."
      sections={[
        {
          heading: "Local Pest Control for Lee's Summit MO",
          body: [
