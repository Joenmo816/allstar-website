...
export const metadata: Metadata = {
  ...
  description:
    "Professional pest control services in Raymore, MO. Residential and commercial extermination services. Call (913) 738-7827 today.",
};
    ...
    <main className="max-w-5xl mx-auto px-4 py-12 space-y-16">
      ...
      <section className="text-center">
        <h1 className="text-4xl font-bold mb-4">
          Pest Control in Raymore, MO
        </h1>

        <p className="text-gray-700 max-w-3xl mx-auto">
          All Star Pest Solutions provides expert residential and commercial
          pest control services in Raymore, Missouri. We eliminate ants,
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4">
          Our Pest Control Services in Raymore
        </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: "https://allstarpestkc.com/raymore"
          }),
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "What pests are common in Raymore, MO?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Common pests in Raymore include ants, spiders, termites, rodents, and wasps."
                }
              },
              {
                "@type": "Question",
