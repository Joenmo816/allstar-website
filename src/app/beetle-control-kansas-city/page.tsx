...
export const metadata: Metadata = {
  title: "Beetle Control Kansas City | All Star Pest Solutions",
  description: "Beetle Control Kansas City from All Star Pest Solutions. Local Kansas City pest control with 30+ years experience, no mandatory contracts, and owner-operated service.",
};
    ...
    <main className="bg-white text-slate-950">
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="mt-8 space-y-5 text-lg leading-8 text-slate-700">
          <p>
            All Star Pest Solutions provides local help for beetles in the Kansas City metro. Pest problems are not all the same, and the right service depends on the pest, the structure, the season, and the conditions around the property.
          </p>
