...
export const metadata: Metadata = {
  ...
  description:
    "Professional pest control services in Lenexa, KS. Residential and commercial extermination services. Call (913) 738-7827 today.",
};
    ...
    <main className="max-w-5xl mx-auto px-4 py-12 space-y-16">
      ...
      <section className="text-center">
        ...
        <p className="text-gray-700 max-w-3xl mx-auto">
          ...
          pest control services in Lenexa, Kansas. We eliminate ants,
          spiders, termites, rodents, wasps, and KSre using safe and effective
          treatment methods.
        </p>
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4">
          Our Pest Control Services in Lenexa
        </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: "https://allstarpestkc.com/lenexa"
          }),
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "What pests are common in Lenexa, KS?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Common pests in Lenexa include ants, spiders, termites, rodents, and wasps."
                }
              },
              {
                "@type": "Question",
