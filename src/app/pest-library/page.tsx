...
export default function PestLibraryPage() {
  const list = [...pests].sort((a,b)=> a.name.localeCompare(b.name));
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {list.map(p => (
          <a key={p.slug} href={`/pest-library/${p.slug}`} className="group rounded-xl border bg-white hover:shadow-md transition overflow-hidden">
