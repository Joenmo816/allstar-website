export default function AboutPage() {
  return (
    <main className='max-w-4xl mx-auto px-4 py-8 space-y-6'>
      ...
      <p>
        We’re a Kansas City, family-owned company focused on service and results.
        Our team uses inspection-first, eco-smart treatments applied precisely per label.
      </p>
