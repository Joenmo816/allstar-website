...
export const pests: Pest[] = [
  ...
  },
  {
    ...
    signs: [
      "Oothecae on stems/fences; sightings on shrubs"
    ],
    healthRisks: [
      "Harmless to people; minor pinch if handled"
    ],
    propertyRisks: [
      "No property damage; beneficial/natural predator"
    ],
    prevention: [
      "Leave undisturbed; they help with general insect control"
    ],
    callToAction: "DIY products rarely resolve the root cause. All Star Pest Solutions uses certified, eco-smart treatments and an IPM approach. Schedule a free inspection."
  },{
    slug: "redwasp",
