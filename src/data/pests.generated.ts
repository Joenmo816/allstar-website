...
export const pests: Pest[] = [
  ...
  },
  {
    ...
    "group": "Roach",
    "risk": "Medium",
    "description": "Brown Banded Cockroach is a pest that may be encountered in and around homes or structures and should be identified correctly so the right control strategy can be used.",
    "facts": {
      "biology": "Brown Banded Cockroach reproduces through egg cases and immature nymph stages before becoming an adult. Roaches thrive where food, water, and shelter are available.",
      "behavior": "Brown Banded Cockroach is usually active at night and hides in cracks, voids, appliances, drains, and secluded harborages during the day.",
      "attractant": "Moisture, food residue, grease buildup, clutter, and harborage voids attract brown banded cockroach.",
      "lifecycle": "Brown Banded Cockroach develops from egg case to nymph to adult.",
